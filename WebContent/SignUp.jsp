				...
				<form id="form" name="signup" action="SignUp" method="post">
					...
					<div id="signfields">
						...
						<ul>
							...
							<div id="dob" class="blacktext14" style="border:0;">Date of Birth</div>
							<li>
					...
					<div id="signfieldsright" class="blacktext" style="padding-top:20px;">
						How other users will recognize you.<br /> 
						You might not want to associate your real name.<br /><br /><br /><br /><br /><br /><br /><br /><br />
						TalkAboutHealth notifies you of conversations via IM.<br /><br /><br /><br />
						You must be over 18 years old to use this service.
					</div>
					<div id="signdown">
