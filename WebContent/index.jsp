	...
	<div class="signin">
		<form id="loginform" action="/tah-java/Login" name="login" method="post" class="loginform">          	
		    	...
		    	<label><span>Username</span>
		    		<input 
		    			id="username" class="input-box" name="username" type="text" maxlength="25" size="25"  TABINDEX=1/>
			    	</input>
			    </label>
			   	<label><span>Password</span>
		    		<input id="password" class="input-box" name="password" type="password" maxlength="25" size="25" TABINDEX=2>
			    	</input>
			    </label>		
